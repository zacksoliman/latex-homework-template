...
\newcommand{\hmwkClass}{Probabilistic Graphical Models}
\newcommand{\hmwkClassTime}{IFT6269}
\newcommand{\hmwkClassInstructor}{Professor Simon Lacoste-Julien}
\newcommand{\hmwkAuthorName}{Zakaria Soliman}
...
\title{
    ...
    \normalsize\vspace{0.1in}\small{Due\ on\ \hmwkDueDate\ at 2:30 pm}\\
...
% Sets
\newcommand{\R}{\mathbb{R}} %corps des reels
...
\newcommand{\scalprod}[2]{\left\langle #1 , \, #2 \right\rangle} %Scalar product
...
\def\ts{\top}
\def\Covm{\boldsymbol{\Sigma}}
\def\varb{\boldsymbol{\sigma}^2}
\def\var{\sigma^2}
